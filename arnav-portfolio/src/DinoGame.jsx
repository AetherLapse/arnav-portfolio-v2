...
const DinoGame = () => {
  ...
  useEffect(() => {
    ...
    // Create hidden image elements for sprites
    Object.entries(SPRITE_DATA).forEach(([id, src]) => {
    ...
    // Create template element for audio resources
    const template = document.createElement('template');
    template.id = 'audio-resources';
    Object.entries(AUDIO_DATA).forEach(([id, src]) => {
      const audio = document.createElement('audio');
      audio.id = id;
      audio.src = src;
      template.content.appendChild(audio);
    });
    outerContainer.appendChild(template);
    ...
    */
    ...
    this.outerContainerEl.tabIndex = 0;
    this.outerContainerEl.style.outline = 'none';
    ...
    */
    ...
    this.outerContainerEl.removeEventListener(Runner.events.MOUSEDOWN, this);
    this.outerContainerEl.removeEventListener(Runner.events.MOUSEUP, this);
    }
    },
    /**
    * Process keydown.
